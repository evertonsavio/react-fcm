...
class App extends Component {
  constructor() {
    ...
    this.state = {
      status: "informações",
      message: "Seu FCM Token será mostrado aqui",
      title: "Suas notificações serão mostradas aqui",
      msgCount: "Quantidade de notificações: 0",
      accordionTabs: []
    };
...
accordionTabList.push(accordionTab);
    ...
    this.setState(...this.state, {
      ...
      msgCount: `Quantidade de notificações: ${accordionTabList.length}`
    });
  }
